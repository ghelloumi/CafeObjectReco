...
def img_preprocessing(orig_img, pixel_means, max_size=1000, scale=500):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--out_fn', type=str, default='res/result.jpg')
    ...
    #if chainer.cuda.available and args.gpu >= 0 else np
